...
htmlhelp_basename = "pyBusPirateLitedoc"
...
latex_documents = [
    (master_doc, "pyBusPirateLite.tex", "pyBusPirateLite Documentation", "Juergen Hasch", "manual"),
]
...
man_pages = [(master_doc, "pyBusPirateLite", "pyBusPirateLite Documentation", [author], 1)]
