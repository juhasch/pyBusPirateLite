...
# -*- coding: utf-8 -*-
#
# pyBusPirateLite documentation build configuration file, created by
# sphinx-quickstart on Sun Jun  4 10:02:36 2017.
#
...
texinfo_documents = [
    (master_doc, 'pyBusPirateLite', 'pyBusPirateLite Documentation',
     author, 'pyBusPirateLite', 'One line description of project.',
     'Miscellaneous'),
]
